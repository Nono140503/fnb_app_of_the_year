            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.cardContainer}>
                        <LessonCard title="Understanding Cash Flow" onPress={() => handleOpenModal('Cash Flow')} />
                        <LessonCard title="Expense Management" onPress={() => handleOpenModal('Expense Management')} />
                    </View>
                </View>

                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Digital Tools for Small Businesses</Text>
                    <View style={styles.cardContainer}>
                        <LessonCard title="Stock Tracking Tools" onPress={() => handleOpenModal('Stock Tracking Tools')} />
                        <LessonCard title="Digital Payments" onPress={() => handleOpenModal('Digital Payments')} />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.cardContainer}>
                        <LessonCard title="Creating Professional Invoices" onPress={() => handleOpenModal('Invoices')} />
                        <LessonCard title="Handling Supplier Orders" onPress={() => handleOpenModal('Supplier Orders')} />
                    </View>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.cardContainer}>
                        <LessonCard title="Getting Access to Loans" onPress={() => handleOpenModal('Loans')} />
                        <LessonCard title="Interest Rates Explained" onPress={() => handleOpenModal('Interest Rates')} />
                    </View>
                </View>

                {/* Footer with FAQs Button */}
                <View style={styles.footer}>
                    <TouchableOpacity style={styles.faqButton} onPress={handleOpenFaqModal}>
                ...
                <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                        <ScrollView>
                            ...
                            <Text style={styles.modalDescription}>{getTopicDescription(selectedTopic)}</Text>
                        </ScrollView>
...
const getFaqContent = () => [
    {
        ...
        answer: 'Monitor your daily transactions, use tools like invoice factoring, and build emergency reserves.',
    },
    {
        question: 'What are digital payment benefits for small businesses?',
        answer: 'Digital payments help reduce theft, provide better record-keeping, and offer convenience for customers.',
    },
    {
        question: 'How does W2Q improve invoicing?',
        answer: 'W2Q converts WhatsApp messages into professional invoices, reducing delays and enhancing documentation.',
    },
    {
        question: 'How can I access small business loans?',
        answer: 'Consider microfinance institutions, government programs, or digital loan platforms tailored for SMEs.',
    },
];
...
const styles = StyleSheet.create({
    ...
    card: { width: '48%', backgroundColor: '#f8f8f8', padding: 15, borderRadius: 8, marginBottom: 10 },
    modalContainer: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.7)' },
    modalContent: { width: '90%', height: '70%', backgroundColor: 'white', padding: 20, borderRadius: 10 },
    modalTitle: { fontSize: 22, fontWeight: 'bold', marginBottom: 10 },
    faqItem: { marginBottom: 15 },
    faqQuestion: { fontWeight: 'bold', marginBottom: 5 },
    faqAnswer: { fontSize: 16, marginBottom: 10 },
    closeButton: { backgroundColor: '#1d61e7', paddingVertical: 10, borderRadius: 5, alignItems: 'center' },
    closeButtonText: { color: 'white', fontWeight: 'bold' },
    footer: { flexDirection: 'row', justifyContent: 'center', marginVertical: 20 },
    faqButton: { backgroundColor: '#1d61e7', padding: 15, borderRadius: 8 },
